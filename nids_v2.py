#!/usr/bin/env python3
"""
Enhanced Network Intrusion Detection System (NIDS) with AI Analysis
Features: OpenAI Integration, Fixed Duration Control, Real-time Monitoring
No WinPcap/Npcap required - Works on all platforms!

Author: Network Security Tool v3.0
"""
...
class FriendlyNIDS:
    """Enhanced Network IDS with AI Analysis - No drivers required!"""
    ...
    def __init__(self):
        ...
        self.settings = {
            ...
            'openai_model': 'gpt-5-nano',  # Default model: gpt-5-nano
    ...
    def setup_gui(self):
        ...
        self.root = tk.Tk()
        self.root.title("🛡️ Enhanced Network IDS with AI Analysis")
    ...
    def create_header(self):
        ...
        title_label = ttk.Label(header_frame, text="🛡️ Network Intrusion Detection System with AI", style='Title.TLabel')
        title_label.pack(pady=15)
        
        subtitle_label = ttk.Label(header_frame, text="Real-time monitoring • AI-powered analysis • No special drivers", style='Status.TLabel')
        subtitle_label.pack()
    ...
    def create_alerts_panel(self):
        ...
        # Add initial message
        self.alerts_text.insert(tk.END, "🛡️ Enhanced Network IDS Ready - Click 'Start Monitoring' to begin\n")
...
3. Specific recommendations for improving security, write it so a beginner can understand
4. Any patterns or anomalies detected, write it so a beginner can understand
...
Please provide a concise but thorough analysis suitable for a security report."""
                    ...
                    response = client.chat.completions.create(
                        ...
                        messages=[
                            {"role": "system", "content": "You are a network security expert analyzing IDS scan results."},
...
- Total Connections Observed: {self.network_stats['total_connections']}
...
"""
        ...
        if self.connections:
            ...
            for ip, data in sorted_ips:
                summary += f"- {ip}: {data['count']} connections\n"
...
• Auto-analyze runs AI analysis automatically"""
        ...
        tk.Label(ai_frame, text=info_text, bg='#2c3e50', fg="#ffffff", 
    ...
    def export_report(self):
        """Export enhanced security report"""
        try:
...
NIDS Version: 3.0 (Enhanced with AI)
...
"""
    ...
    def run(self):
        ...
        try:
            print("🛡️ Starting Enhanced Network IDS with AI...")
...
""")
    ...
    print("\n👋 Thank you for using Enhanced Network IDS!")
